...
pub fn convolution_998_upper223(a: Vec<u32>, b: Vec<u32>) -> Vec<u32> {
    ...
    let c1 = Ntt::new().convolution(na, nb);
    ...
    let c2 = Ntt::new().convolution(na, nb);
    ...
    let c3 = Ntt::new().convolution(na, nb);
...
pub fn convolution_mod_2_64(a: Vec<u64>, b: Vec<u64>) -> Vec<u64> {
    ...
    let c4 = Ntt::new().convolution(na, nb);
    ...
    let c5 = Ntt::new().convolution(na, nb);
    ...
    let c6 = Ntt::new().convolution(na, nb);
    ...
    let c7 = Ntt::new().convolution(na, nb);
