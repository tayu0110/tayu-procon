...
impl PointSetableRollingHash {
    ...
    /// # Example
    /// ```rust
    /// use string::PointSetableRollingHash;
    ///
    /// let s = "abdabfgdabfgda";
    /// let hash = PointSetableRollingHash::new(s);
    ///
    ...
    /// use string::PointSetableRollingHash;
    ///
    /// let s = PointSetableRollingHash::new("abcdefg");
    /// let t = PointSetableRollingHash::new("abcdfg");
    ///
    /// // "abcdefg" and "abcdfg"
    /// assert_eq!(s.lcp(.., &t, ..), 4);
    /// // "bcdefg" and "bcdfg"
