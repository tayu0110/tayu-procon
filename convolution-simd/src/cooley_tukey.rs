    ...
    if offset == 1 && blocks >= 8 {
        ...
        for block in 1..blocks {
            ...
            for _ in (top..top + offset).step_by(8) {
                ...
                let (r0, r1, r2, r3) = radix4_inner!(Modintx8::load(c0a), Modintx8::load(c1a), Modintx8::load(c2a), Modintx8::load(c3a), rot, rot2, rot3, imag);
                r0.store(c0a);
                r1.store(c1a);
                r2.store(c2a);
                r3.store(c3a);
            ...
            rot = rot * Modintx8::splat(rate[(!block).trailing_zeros() as usize]);
        }
    }
}
